import { version, getCurrentInstance, inject, ref, watchEffect, watch, useSSRContext, createApp, reactive, unref, provide, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, toRef, shallowRef, computed, isReadonly, defineAsyncComponent, isRef, withCtx, nextTick, defineComponent, h, Suspense, Transition } from 'file://E:/Freelancer/Demo/demo/node_modules/vue/index.mjs';
import { $fetch } from 'file://E:/Freelancer/Demo/demo/node_modules/ofetch/dist/node.mjs';
import { createHooks } from 'file://E:/Freelancer/Demo/demo/node_modules/hookable/dist/index.mjs';
import { getContext, executeAsync } from 'file://E:/Freelancer/Demo/demo/node_modules/unctx/dist/index.mjs';
import { renderSSRHead } from 'file://E:/Freelancer/Demo/demo/node_modules/@unhead/ssr/dist/index.mjs';
import { getActiveHead, createServerHead as createServerHead$1 } from 'file://E:/Freelancer/Demo/demo/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file://E:/Freelancer/Demo/demo/node_modules/@unhead/shared/dist/index.mjs';
import { createMemoryHistory, createRouter, useRoute as useRoute$1, RouterView } from 'file://E:/Freelancer/Demo/demo/node_modules/vue-router/dist/vue-router.node.mjs';
import { createError as createError$1, sanitizeStatusCode } from 'file://E:/Freelancer/Demo/demo/node_modules/h3/dist/index.mjs';
import { hasProtocol, parseURL, joinURL } from 'file://E:/Freelancer/Demo/demo/node_modules/ufo/dist/index.mjs';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode } from 'file://E:/Freelancer/Demo/demo/node_modules/vue/server-renderer/index.mjs';
import { defu } from 'file://E:/Freelancer/Demo/demo/node_modules/defu/dist/defu.mjs';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-2f4e40ec.mjs').then((m) => m.default || m)
  }
];
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-component-a7127059.mjs').then((r) => r.default || r));
